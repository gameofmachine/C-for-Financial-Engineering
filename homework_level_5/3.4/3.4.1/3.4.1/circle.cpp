...
namespace XIANGZOU
{
	namespace CAD
	{
		Circle::Circle():center(0.0,0.0),m_radius(1.0){}

		Circle::Circle(const Point & a, const double & r):center(a),m_radius(r){}

		Circle::Circle(const Circle & O):center(O.center),m_radius(O.m_radius){}
